Note: for support questions on R package **metabook**, please use the [R-sig-meta-analysis mailing list](https://stat.ethz.ch/mailman/listinfo/r-sig-meta-analysis). This repository's issues are reserved for feature requests and bug reports.
...
```r
bug.report(package = "metabook") # not supported in RStudio
```
